                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-striped">
                                    ...
                                    <a href='viewsup.php?id=$row[supplier_id]'><button type='button' class='btn btn-outline-primary btn-rounded btn-icon'><i class='mdi mdi-eye' ></i></button></a>&nbsp;
                                
                                    <a href='updatesupplier.php?id=$row[supplier_id]'><button type='button' class='btn btn-outline-warning btn-rounded btn-icon'>
                          <i class='mdi mdi-border-color text-warning' ></i></button></a>&nbsp;
                                    <a href='db-deletesupplier.php?id=" . $row['supplier_id'] . "' onclick =\"return confirm('กรุณายืนยันการลบข้อมูล')\">  
