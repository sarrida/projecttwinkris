            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">ประวัติข้อมูลซับพลายเออร์</h4>
                                <form class="form-sample" method="post" action="db-updatesupplier.php?id=<?php echo $ID; ?> ">
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class=" col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class=" col-sm-8">
                                                    <input type="text" class="form-control" name="supplier_phone" value="<?php echo $row['supplier_phone'] ?> " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
