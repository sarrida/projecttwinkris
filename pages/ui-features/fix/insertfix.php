                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-sample" method="post" action="db-insertfix.php">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <input autocomplete="off" type="text" id="e_id" name="e_id" class="form-control" list='list'>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <input autocomplete="off" type="text" id="mechine_id" name="mechine_id" class="form-control" list='list1'>
                                    ...
                                    <div class="row">
                                        <div class=" col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class=" col-sm-9">
                                                    <input type="date" class="form-control" placeholder="dd/mm/yyyy" name="fix_date">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="exampleTextarea1" rows="12" name="fix_detail" type="text"></textarea>
                                    </div>
