            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">ประวัติข้อมูลเครื่องจักร</h4><br><br>
                                <form class="form-sample" method="post" action="db-insertmechine.php">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">ชื่อเครื่องจักร</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="mechine_name" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="mechine_type" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class=" col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class=" col-sm-8">
                                                    <input type="text" class="form-control" name="mechine_amout" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
