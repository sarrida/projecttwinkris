...
<body>
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            $ID = $_REQUEST['id'];
            $sql = "SELECT * FROM pay where pay_id = '$ID' ";
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">ประวัติข้อมูลการชำระ</h4><br><br>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class=" col-sm-9">
                                                    <input type="date" class="form-control" placeholder="dd/mm/yyyy" id="date_pay" name="date_pay" value="<?php echo $row['date_pay'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class=" col-md-5">
                                            <div class="form-group row">
                                                ...
                                                <div class="btn btn-outline-info col-sm-7">
                                                    <input type="file" name="p_img" value="<?php echo $row['p_img'] ?> ">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
