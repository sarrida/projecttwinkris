            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">ประวัติข้อมูลการทำงาน</h4><br><br>
                                <form class="form-sample" method="post" action="db-insertwork.php">
                                    <div class="row">
                                        <div class=" col-md-6">
                                    ...
                                    <!-- <div class="row">
                                            <div class=" col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label">จำนวนการทำงาน</label>
                                                    <div class=" col-sm-9">
                                                        <input type="text" class="form-control" name="work_amout">
                                                    </div>
                                                </div>
                                            </div>
                                        </div> -->
