                                ...
                                <table class="table table-striped">
                                    <thead align="center">
                                        <tr>
                                            ...
                                            // $sql = "SELECT * FROM work INNER JOIN employee on employee.e_id=work.e_id WHERE employee.e_id LIKE '1' and work.start_date LIKE '2019-11%' ";
                                    ...
                                    <a href='viewwork.php?id=$row[work_id]'><button type='button' class='btn btn-outline-primary btn-rounded btn-icon'><i class='mdi mdi-eye' ></i></button></a>&nbsp;
                                    <a href='updatework.php?id=$row[work_id]'><button type='button' class='btn btn-outline-warning btn-rounded btn-icon'>
                          <i class='mdi mdi-border-color text-warning' ></i></button></a>&nbsp;
                                    <a href='db-deletework.php?id=" . $row['work_id'] . "'onclick=\"return confirm('ต้องการจะลบข้อมูลนี้ใช่หรือไม่?')\">
