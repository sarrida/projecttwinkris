                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-sm-12">
                                        <section class="panel">
                                            <table class="table table-bordered" id="customer">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td width=30% class="table-primary" align="right">รหัสพนังงาน</td>
                                                    ...
                                                    <tr>
                                                        <td width=30% class="table-primary" align="right">ตำแหน่งงาน</td>
                                                        <td><?php echo $row['e_rank'] ?></td>
                                                    </tr>
                                                </tbody>
                                                </thead>
                                            </table>
                                ...
                                <br>
                                <div align="center">
                                    <a href="employee.php"><button typr="cancel" class="btn btn-outline-primary  btn-rounded btn-fw"><span>กลับ</span> </button></a>
                                </div>
                            </div>
                        </div>
                    </div>
