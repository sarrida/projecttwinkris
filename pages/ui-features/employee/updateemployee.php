            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">ประวัติข้อมูลพนักงาน</h4>
                                <form class="form-sample" method="post" action="db-updateemployee.php?id=<?php echo $ID; ?> ">
                                    <div class=" row">
                                        <div class="col-md-6">
                                        ...
                                        <div class=" col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class=" col-sm-9">
                                                    <input type="text" class="form-control" name="e_surename" value="<?php echo $row['e_surename'] ?> " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control" name="e_gender" value="<?php echo $row['e_gender'] ?> ">
                                                        <option>เพศ</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="e_phone" value="<?php echo $row['e_phone'] ?> " />
                                                </div>
                                            </div>
                                        </div>
                                        <div class=" col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="e_email" value="<?php echo $row['e_email'] ?>" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select type="text" class="form-control" name="e_rank" value="<?php echo $row['e_rank'] ?>">
