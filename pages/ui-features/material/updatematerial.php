                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-sample" method="post" action="db-updatematerial.php?id=<?php echo $ID; ?>">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">ชื่อวัตถุดิบ</label>
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control" name="material_name" value="<?php echo $row['material_name'] ?> " />
                                                </div>
                                            </div>
                                        </div>
                                        <div class=" col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class=" col-sm-6">
                                                    <input type="text" class="form-control" name="material_amout" value="<?php echo $row['material_amout'] ?>" />
                                                    <select class=" form-control" name="type_rm" value="<?php echo $row['type_rm'] ?>">
